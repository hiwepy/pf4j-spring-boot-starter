...
/**
 * Unit tests for {{ @link Pf4jUpdateAutoConfiguration }}.
 *
 ...
 * @since 1.0.0
 */
@DisplayName("Pf4jUpdateAutoConfiguration Tests")
class Pf4jUpdateAutoConfigurationTest {
    ...
    void testInstantiation() {
        Pf4jUpdateAutoConfiguration configuration = new Pf4jUpdateAutoConfiguration();

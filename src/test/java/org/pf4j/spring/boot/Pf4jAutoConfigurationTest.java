...
/**
 * Unit tests for {{ @link Pf4jAutoConfiguration }}.
 *
 ...
 * @since 1.0.0
 */
@DisplayName("Pf4jAutoConfiguration Tests")
class Pf4jAutoConfigurationTest {
    ...
    void testInstantiation() {
        Pf4jAutoConfiguration configuration = new Pf4jAutoConfiguration();
        assertThat(configuration).isNotNull();
    }

    @Test
    @DisplayName("Auto-configuration loads when 'pf4j.enabled=true'")
    void testLoadsWhenEnabledPropertySet() {
        runner.withUserConfiguration(Pf4jAutoConfiguration.class)
                ...
                .run(context -> assertThat(context).hasSingleBean(Pf4jAutoConfiguration.class));
    }
